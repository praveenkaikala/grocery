        ...
        <div className='grid md:grid-cols-3 grid-cols-2 lg:grid-cols-4 py-4 gap-3'>
                {
                    products && (
                        products.map((item,key)=>{
                            return(
                                <div className='flex flex-col items-center width-auto group cursor-pointer justify-between border p-3 rounded-md transition-all ease-in-out my-3' key={key}>
                                    <Image
                                  ...
                                  <h2 className='font-extralight line-through'>${item?.mrp}</h2>
